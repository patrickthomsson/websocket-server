...
public class ChallengeCalculator {
	...
	public String calculateVersion6Challenge(String secWebSocketKey) {
		LOG.debug("Calculating version 6 challenge from secWebSocketKey: " + secWebSocketKey);
	...
	public String calculate(String key1, String key2, String randomBits) {
		LOG.debug(String.format("key1: '%s', key2: '%s', randomBit: '%s'", key1, key2, randomBits));
